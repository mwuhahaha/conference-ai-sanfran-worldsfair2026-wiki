...
- Weak slide OCR should be reread with the RapidOCR merge tool before refreshing slide pages. Run `python3 scripts/improve_slide_ocr_rapidmerge.py`, then `python3 scripts/refresh_slide_pages_from_ocr.py`; the audit lives at `raw/sources/slide-ocr-rapidmerge-audit.json` and `wiki/resources/slide-ocr-rapidmerge-audit.md`.
