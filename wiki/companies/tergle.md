...
The connection matters because it helps explain why the talk has a startup-operating-model flavor even though the deployment environment is government: fast product loops, embedded discovery, workflow automation, and an emphasis on shipping useful systems rather than writing strategy slides.
