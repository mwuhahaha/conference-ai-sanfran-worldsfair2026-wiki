...
## Slide/OCR Coverage
- [[slide-library]] tracks 454 extracted video slide decks.
- 3787 slide/frame images are embedded in deck pages.
- 3713 extracted frames have non-empty local OCR text.
