...
## Slide/OCR Coverage
- [[slide-library]] tracks 406 extracted video slide decks.
- 2944 slide/frame images are embedded in deck pages.
- 2881 extracted frames have non-empty local OCR text.
