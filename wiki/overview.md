...
## Slide/OCR Coverage
- [[slide-library]] tracks 403 extracted video slide decks.
- 2918 slide/frame images are embedded in deck pages.
- 2855 extracted frames have non-empty local OCR text.
