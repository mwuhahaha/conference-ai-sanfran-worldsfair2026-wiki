...
## Slide/OCR Coverage
- [[slide-library]] tracks 431 extracted video slide decks.
- 3400 slide/frame images are embedded in deck pages.
- 3326 extracted frames have non-empty local OCR text.
