...
category: "playbooks"
status: "seeded"
sourceLabels: ["Policy evals", "Question index", "Source map", "Source rules"]
---
# Source-Grounded Conference Briefing

## Overview
A briefing workflow for turning the conference wiki into a decision memo without losing source boundaries.
...
## When To Use
Use this when preparing an executive summary, research memo, or next-build plan from the Worldsfair corpus.
