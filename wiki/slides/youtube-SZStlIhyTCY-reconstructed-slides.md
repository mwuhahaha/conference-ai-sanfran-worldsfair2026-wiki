---
title: "Reconstructed Slides: Moving away from Agile: What's Next – Martin Harrysson & Natasha Maniar, McKinsey & Company"
category: "slides"
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/reconstructed/SZStlIhyTCY/slide-002.html)
- AI slide classifier: `content_slide` confidence `0.97`
- Text source: advanced OCR `rapidocr-live/bright-screen/contrast`.
- OCR decision: ready — Dense text-heavy slide with chart labels and small supporting images.
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/reconstructed/SZStlIhyTCY/slide-003.html)
- AI slide classifier: `content_slide` confidence `0.99`
- Text source: advanced OCR `rapidocr-live/bright-screen/contrast`.
- OCR decision: ready — Full text-heavy slide with multiple labeled sections and images.
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/reconstructed/SZStlIhyTCY/slide-004.html)
- AI slide classifier: `content_slide` confidence `0.98`
- Text source: advanced OCR `rapidocr-live/bright-screen/contrast`.
- OCR decision: ready — Dense slide plus lower-third title card and sponsor footer; OCR is better than manual transcription here.
...
![[assets/reconstructed-slides/SZStlIhyTCY/slide-005.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/reconstructed/SZStlIhyTCY/slide-005.html)
- AI slide classifier: `content_slide` confidence `0.99`
...
![[assets/reconstructed-slides/SZStlIhyTCY/slide-006.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/reconstructed/SZStlIhyTCY/slide-006.html)
- AI slide classifier: `content_slide` confidence `0.99`
- Text source: advanced OCR `rapidocr-live/bright-screen/contrast`.
- OCR decision: ready — Text-dense chart slide with axis labels, numbered bottleneck list, and footer logos.
...
![[assets/reconstructed-slides/SZStlIhyTCY/slide-007.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/reconstructed/SZStlIhyTCY/slide-007.html)
- AI slide classifier: `content_slide` confidence `0.98`
- Text source: advanced OCR `rapidocr-live/bright-screen/opencv-adaptive`.
- OCR decision: ready — Diagram slide with multiple small labels and boxed annotations; OCR is likely better than manual transcription.
...
![[assets/reconstructed-slides/SZStlIhyTCY/slide-009.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/reconstructed/SZStlIhyTCY/slide-009.html)
- AI slide classifier: `content_slide` confidence `0.99`
- Text source: advanced OCR `rapidocr-live/bright-screen/contrast`.
- OCR decision: ready — Dense multi-column operating-model slide with many small text blocks and labels.
...
![[assets/reconstructed-slides/SZStlIhyTCY/slide-010.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/reconstructed/SZStlIhyTCY/slide-010.html)
- AI slide classifier: `content_slide` confidence `0.99`
- Text source: advanced OCR `rapidocr-live/bright-screen/contrast`.
- OCR decision: ready — Text-heavy chart slide with small labels, multipliers, and outcome callouts suitable for OCR.
...
![[assets/reconstructed-slides/SZStlIhyTCY/slide-011.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/reconstructed/SZStlIhyTCY/slide-011.html)
- AI slide classifier: `content_slide` confidence `0.99`
- Text source: advanced OCR `rapidocr-live/bright-screen/contrast`.
- OCR decision: ready — Dense comparison slide with multiple small cards and labels; OCR is the best triage path.
...
![[assets/reconstructed-slides/SZStlIhyTCY/slide-013.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/reconstructed/SZStlIhyTCY/slide-013.html)
- AI slide classifier: `content_slide` confidence `0.98`
- Text source: advanced OCR `rapidocr-live/bright-screen/contrast`.
- OCR decision: ready — Dense metrics, multiple labels, and small footer text are better handled by OCR.
...
![[assets/reconstructed-slides/SZStlIhyTCY/slide-014.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/reconstructed/SZStlIhyTCY/slide-014.html)
- AI slide classifier: `content_slide` confidence `0.99`
- Text source: agent_vision.
...
![[assets/reconstructed-slides/SZStlIhyTCY/slide-015.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/reconstructed/SZStlIhyTCY/slide-015.html)
- AI slide classifier: `content_slide` confidence `0.98`
- Text source: advanced OCR `rapidocr-live/bright-screen/contrast`.
- OCR decision: ready — Diagram with many small labels and role names; OCR will capture the team structure more reliably than manual transcription.
...
![[assets/reconstructed-slides/SZStlIhyTCY/slide-016.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/reconstructed/SZStlIhyTCY/slide-016.html)
- AI slide classifier: `content_slide` confidence `0.98`
- Text source: none.
- OCR decision: ready — Two-column org-structure diagram with many small labels and role names is OCR-suitable.
![[assets/reconstructed-slides/SZStlIhyTCY/slide-017.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/reconstructed/SZStlIhyTCY/slide-017.html)
- AI slide classifier: `content_slide` confidence `0.99`
- Text source: agent_vision.
...
![[assets/reconstructed-slides/SZStlIhyTCY/slide-018.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/reconstructed/SZStlIhyTCY/slide-018.html)
- AI slide classifier: `content_slide` confidence `0.98`
- Text source: advanced OCR `rapidocr-live/bright-screen/contrast`.
- OCR decision: ready — Chart labels, annotations, and the right-side unlock list are dense enough that OCR is the better first pass.
...
![[assets/reconstructed-slides/SZStlIhyTCY/slide-019.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/reconstructed/SZStlIhyTCY/slide-019.html)
- AI slide classifier: `content_slide` confidence `0.95`
- Text source: advanced OCR `rapidocr-live/bright-screen/contrast`.
- OCR decision: ready — Dense mixed-layout slide with diagram labels, small body text, and a stage-crop composition that is better handled by OCR than direct transcription.
...
- [`slide-012.jpg`](/assets/reconstructed-slides/SZStlIhyTCY/slide-012.jpg) — `other` confidence `0.99`; Audience shot, not a presentation slide.
- [`slide-020.jpg`](/assets/reconstructed-slides/SZStlIhyTCY/slide-020.jpg) — `title_card` confidence `0.99`; brand/title splash, not a substantive presentation content slide
