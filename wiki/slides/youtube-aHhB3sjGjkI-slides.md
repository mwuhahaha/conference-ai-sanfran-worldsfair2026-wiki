...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/aHhB3sjGjkI/slide-002.html)
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/aHhB3sjGjkI/slide-003.html)
- AI slide classifier: `content_slide` confidence `0.97`
- Text source: agent_vision.
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/aHhB3sjGjkI/slide-004.html)
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/aHhB3sjGjkI/slide-005.html)
- AI slide classifier: `content_slide` confidence `0.99`
- Text source: advanced OCR `rapidocr-live/bright-screen/contrast`.
- OCR decision: ready — diagram slide with small labels
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/aHhB3sjGjkI/slide-006.html)
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/aHhB3sjGjkI/slide-007.html)
- AI slide classifier: `content_slide` confidence `0.98`
- Text source: advanced OCR `rapidocr-live/bright-screen/opencv-adaptive`.
- OCR decision: ready — Dense table/spreadsheet screenshot with small text and many rows is better handled by OCR.
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/aHhB3sjGjkI/slide-008.html)
- AI slide classifier: `content_slide` confidence `0.99`
- Text source: agent_vision.
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/aHhB3sjGjkI/slide-009.html)
- AI slide classifier: `content_slide` confidence `0.98`
- Text source: advanced OCR `rapidocr-live/bright-screen/opencv-adaptive`.
- OCR decision: ready — Chart screenshot with many small labels and annotations is OCR-suitable.
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/aHhB3sjGjkI/slide-010.html)
- AI slide classifier: `content_slide` confidence `0.97`
- Text source: advanced OCR `rapidocr-live/bright-screen/opencv-adaptive`.
- OCR decision: ready — GitHub repository screenshot contains dense UI text that OCR can recover more accurately than direct reading.
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/aHhB3sjGjkI/slide-011.html)
- AI slide classifier: `content_slide` confidence `0.98`
- Text source: advanced OCR `rapidocr-live/bright-screen/contrast`.
- OCR decision: ready — Chart and embedded table are dense enough that OCR is preferable.
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/aHhB3sjGjkI/slide-012.html)
- AI slide classifier: `content_slide` confidence `0.99`
- Text source: agent_vision.
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/aHhB3sjGjkI/slide-013.html)
- AI slide classifier: `content_slide` confidence `0.98`
- Text source: agent_vision.
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/aHhB3sjGjkI/slide-014.html)
- AI slide classifier: `content_slide` confidence `0.99`
- Text source: advanced OCR `rapidocr-live/bright-screen/opencv-adaptive`.
- OCR decision: ready — Dense code/editor screenshot with small text; OCR should read it better than manual vision transcription.
...
> **Path+*:/Users/alfonsograziano/Desktop/exp/auto-agent-demo t*Branch**B oaster
> Metries
...
> **prieary aetric**B accuracy(maximize) **Secondary constraints**: latency avg ns9 max 20t regression cost usd: max 5os regression

![[assets/slides/aHhB3sjGjkI/slide-015.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/aHhB3sjGjkI/slide-015.html)
- AI slide classifier: `content_slide` confidence `0.98`
- Text source: advanced OCR `rapidocr-live/bright-screen/contrast`.
- OCR decision: ready — Flowchart with many small labels and repeated text; OCR is suitable for the diagram body.
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/aHhB3sjGjkI/slide-016.html)
- AI slide classifier: `content_slide` confidence `0.99`
- Text source: advanced OCR `rapidocr-live/bright-screen/opencv-adaptive`.
- OCR decision: ready — Dense dark report screenshot with small text and many numeric details; OCR is the right extraction path.
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/aHhB3sjGjkI/slide-017.html)
- AI slide classifier: `content_slide` confidence `0.98`
- Text source: advanced OCR `rapidocr-live/bright-screen/opencv-adaptive`.
- OCR decision: ready — Flowchart slide with multiple small labels and note text; OCR will be more reliable for the box text.
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/aHhB3sjGjkI/slide-018.html)
- AI slide classifier: `content_slide` confidence `0.97`
- Text source: advanced OCR `rapidocr-live/bright-screen/contrast`.
- OCR decision: ready — Repeated flowchart structure with tiny text labels; OCR is suitable for reading the boxes and connectors.
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/aHhB3sjGjkI/slide-019.html)
- AI slide classifier: `content_slide` confidence `0.99`
- Text source: advanced OCR `rapidocr-live/bright-screen/contrast`.
- OCR decision: ready — Dense table plus multiple bullet points; OCR will capture the iteration summary more reliably than manual triage.
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/aHhB3sjGjkI/slide-020.html)
- AI slide classifier: `content_slide` confidence `0.99`
- Text source: agent_vision.
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/aHhB3sjGjkI/slide-021.html)
- AI slide classifier: `content_slide` confidence `0.99`
- Text source: agent_vision.
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/aHhB3sjGjkI/slide-022.html)
- AI slide classifier: `content_slide` confidence `0.98`
- Text source: agent_vision.
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/aHhB3sjGjkI/slide-023.html)
- AI slide classifier: `content_slide` confidence `0.98`
- Text source: agent_vision.
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/aHhB3sjGjkI/slide-024.html)
- AI slide classifier: `content_slide` confidence `0.99`
- Text source: advanced OCR `rapidocr-live/bright-screen/contrast`.
- OCR decision: ready — Code/terminal-like slide with small dense text and a command line snippet; OCR is more suitable than manual transcription in this pass.
