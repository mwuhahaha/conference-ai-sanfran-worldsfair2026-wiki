---
title: "Slides: Beyond the Harness: A Journey Towards Adaptative Engineering - Rajiv Chandegra, Annicha Labs"
category: "slides"
video_id: "qdZzND79mcg"
sourceLabels: ["Public YouTube video frames", "Public YouTube metadata"]
---

# Slides: Beyond the Harness: A Journey Towards Adaptative Engineering - Rajiv Chandegra, Annicha Labs
...
## Extracted Slides
![[assets/slides/qdZzND79mcg/slide-001.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/qdZzND79mcg/slide-001.html)
...
![[assets/slides/qdZzND79mcg/slide-002.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/qdZzND79mcg/slide-002.html)
- AI slide classifier: `content_slide` confidence `0.98`
- Text source: advanced OCR `rapidocr-live/border-trim/contrast`.
- OCR decision: ready — Dense multi-section slide with small text and diagrams; OCR will read it more reliably than direct transcription.
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/qdZzND79mcg/slide-003.html)
- AI slide classifier: `content_slide` confidence `0.98`
- Text source: advanced OCR `rapidocr-live/border-trim/contrast`.
- OCR decision: ready — Dense text slide with small body copy and a multi-item list; OCR is the better extraction path.
...
![[assets/slides/qdZzND79mcg/slide-004.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/qdZzND79mcg/slide-004.html)
- AI slide classifier: `content_slide` confidence `0.98`
- Text source: advanced OCR `rapidocr-live/border-trim/opencv-adaptive`.
- OCR decision: ready — Dense explanatory slide with multiple small text sections; OCR is the right extraction method.

Slide text:

> Uses + Failure Modes of Fixed (factory) Harnessing
...
![[assets/slides/qdZzND79mcg/slide-005.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/qdZzND79mcg/slide-005.html)
...
![[assets/slides/qdZzND79mcg/slide-006.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/qdZzND79mcg/slide-006.html)
- AI slide classifier: `content_slide` confidence `0.98`
- Text source: advanced OCR `rapidocr-live/bright-screen/contrast`.
- OCR decision: ready — Diagram slide with small explanatory text and labels; OCR is the appropriate extraction path.
...
![[assets/slides/qdZzND79mcg/slide-007.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/qdZzND79mcg/slide-007.html)
- AI slide classifier: `content_slide` confidence `0.99`
- Text source: agent_vision.
...
![[assets/slides/qdZzND79mcg/slide-008.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/qdZzND79mcg/slide-008.html)
- AI slide classifier: `content_slide` confidence `0.99`
- Text source: advanced OCR `rapidocr-live/border-trim/opencv-adaptive`.
- OCR decision: ready — Dense quote and paragraph slide with small text; OCR is likely more reliable than direct transcription.

Slide text:

> Adaptative Engineering
...
![[assets/slides/qdZzND79mcg/slide-009.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/qdZzND79mcg/slide-009.html)
- AI slide classifier: `content_slide` confidence `0.98`
- Text source: agent_vision.
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/qdZzND79mcg/slide-010.html)
- AI slide classifier: `content_slide` confidence `0.98`
- Text source: agent_vision.
...
![[assets/slides/qdZzND79mcg/slide-011.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/qdZzND79mcg/slide-011.html)
- AI slide classifier: `content_slide` confidence `0.99`
- Text source: advanced OCR `rapidocr-live/border-trim/contrast`.
- OCR decision: ready — Multi-column text slide with small body copy; OCR is the efficient extraction path.

Slide text:

> the engineer; it Adaptive: engineering of engineering relocates does not the emphasis abolish
...
![[assets/slides/qdZzND79mcg/slide-012.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/qdZzND79mcg/slide-012.html)
- AI slide classifier: `content_slide` confidence `0.99`
- Text source: advanced OCR `rapidocr-live/border-trim/opencv-adaptive`.
- OCR decision: ready — Dense comparison/architecture slide with small labels and many text elements; OCR is appropriate.

Slide text:

> Purely Fixed Harness Claude Code Langchain Hermes. Cursor Goose Codex Cline Vertical vs horlzontal Entelligence Fully Adaptive Harness
> P:v.:r+.
...
![[assets/slides/qdZzND79mcg/slide-013.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/qdZzND79mcg/slide-013.html)
- AI slide classifier: `content_slide` confidence `0.97`
- Text source: advanced OCR `rapidocr-live/border-trim/opencv-adaptive`.
- OCR decision: ready — Dense multi-column text with small body copy; OCR will be more reliable than manual transcription in this pass.
...
![[assets/slides/qdZzND79mcg/slide-014.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/qdZzND79mcg/slide-014.html)
- AI slide classifier: `content_slide` confidence `0.97`
- Text source: advanced OCR `rapidocr-live/bright-screen/opencv-adaptive`.
- OCR decision: ready — Dense comparison table with small text; OCR is appropriate for accurate extraction.

Slide text:

> PrOpLAiT HARHESS CHGINEIRING.THE FACTORY ADAPTIVE CNGINEERIRC. IHE FOREST
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/qdZzND79mcg/slide-015.html)
- AI slide classifier: `content_slide` confidence `0.96`
- Text source: advanced OCR `rapidocr-live/border-trim/opencv-adaptive`.
- OCR decision: ready — Bullet-heavy slide with several small lines; OCR should capture the detailed list better than manual triage.
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/qdZzND79mcg/slide-016.html)
- AI slide classifier: `content_slide` confidence `0.99`
- Text source: agent_vision.
