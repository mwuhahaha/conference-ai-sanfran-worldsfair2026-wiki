---
title: "Dense Slides: Trends Across the AI Frontier — George Cameron, ArtificialAnalysis.ai"
category: "slides"
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/dense/sRpqPgKeXNk/slide-001.html)
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/dense/sRpqPgKeXNk/slide-002.html)
- AI slide classifier: `content_slide` confidence `0.99`
- Text source: advanced OCR `rapidocr-live/bright-screen/opencv-adaptive`.
- OCR decision: ready — Dense chart slide with many small labels and bars; OCR is appropriate.
...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/dense/sRpqPgKeXNk/slide-003.html)
- AI slide classifier: `content_slide` confidence `0.99`
- Text source: advanced OCR `rapidocr-live/bright-screen/opencv-adaptive`.
- OCR decision: ready — Scatterplot/diagram with dense labels and small text; OCR is appropriate.
...
![[assets/dense-slides/sRpqPgKeXNk/slide-004.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/dense/sRpqPgKeXNk/slide-004.html)
- AI slide classifier: `content_slide` confidence `0.99`
- Text source: advanced OCR `rapidocr-live/bright-screen/opencv-adaptive`.
- OCR decision: ready — Dense benchmark chart with many labels and timing values; OCR is appropriate.
...
![[assets/dense-slides/sRpqPgKeXNk/slide-005.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/dense/sRpqPgKeXNk/slide-005.html)
- AI slide classifier: `content_slide` confidence `0.99`
- Text source: advanced OCR `rapidocr-live/bright-screen/opencv-adaptive`.
- OCR decision: ready — Two dense bar charts with many small labels; OCR is appropriate.
...
![[assets/dense-slides/sRpqPgKeXNk/slide-006.jpg]]

- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/dense/sRpqPgKeXNk/slide-006.html)
- AI slide classifier: `content_slide` confidence `0.99`
- Text source: advanced OCR `rapidocr-live/bright-screen/contrast`.
- OCR decision: ready — Dense cost comparison chart with many labels and values; OCR is appropriate.
