...
- Recreated text/layout view: [open HTML recreation](/assets/slide-recreations/slides/zKk7sDMGDEQ/slide-002.html)
- AI slide classifier: `content_slide` confidence `0.93`
- Text source: advanced OCR `rapidocr-live/border-trim/contrast`.
- OCR decision: ready — dense screenshot-style slide with small text and mixed elements
