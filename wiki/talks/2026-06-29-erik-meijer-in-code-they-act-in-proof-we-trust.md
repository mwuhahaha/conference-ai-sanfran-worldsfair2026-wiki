...
- **Proof-carrying code** — The idea of attaching a proof to code so execution is allowed only after verification.
- [[software-factories|Program verification]] — Turning agent intent into a program that can be inspected and analyzed statically.
- [[agent-security|Static analysis]] — Using compiler methods like type checking and data-flow analysis on agent programs.
