---
title: "2 hr deep dive on LLM Inference at Scale — Part 1 of 2"
category: "talks"
date: "2026-06-29"
time: "12:10pm-1:10pm"
...
# 2 hr deep dive on LLM Inference at Scale — Part 1 of 2 ## Conference Context - Date/time: 2026-06-29 · 12:10pm-1:10pm - Track/room: Workshops Day 1 · Track 3 - Speaker(s): Harshul Jain, Tanmay Sah - Session type/status: workshop · confirmed - Track: Workshops Day 1 - Room: Track 3 - Session type: workshop - Status: confirmed ## Session Description Most engineers using LLMs can call an API. Far fewer can explain why their model is slow, why it's running out of memory, or how the inference engines powering every major LLM API actually work. This workshop walks through the full inference stack — from how a transformer generates a single token to serving billions of tokens a day with vLLM, SGLang, TensorRT-LLM, Ray, and KServe/llm-d. 60% explanation with live demos, 40% hands-on exercises.

### Speaker And Company Context
- [[harshul-jain|Harshul Jain]] — Senior Software Engineer - ML/AI at [[audible|Audible]].
- [[tanmay-sah|Tanmay Sah]] — Senior Quantitative Modeler at [[zions-bancorporation|Zions Bancorporation]].
