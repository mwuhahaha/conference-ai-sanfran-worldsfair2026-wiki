...
room: "Track 3"
speakers: ["Hiral Shah", "Sean Sodha"]
...
# Your Agreements Are a Database You Can't Query. We're Fixing That ## Conference Context - Date/time: 2026-06-29 · 1:55pm-2:15pm - Track/room: Search & Retrieval · Track 3 - Speaker(s): Hiral Shah, Sean Sodha - Session type/status: session · confirmed - Track: Search & Retrieval - Room: Track 3 - Session type: session - Status: confirmed ## Session Description Agreements power every enterprise business, but the most critical data — pricing schedules, SLA obligations, rate cards — is often trapped in tables that traditional extraction tools destroy. This session shows what changes when you can actually extract that data accurately at scale and make it searchable. We'll walk through the before and after: Before: Contract tables require manual review.

### Speaker And Company Context
- [[hiral-shah|Hiral Shah]] — Senior Director of Product, AI Applications at [[docusign|Docusign]].
- [[sean-sodha|Sean Sodha]] — Senior Product Manager at [[nvidia|NVIDIA]].
