---
title: "From approval loops to autonomous agents with Docker pt4"
category: "talks"
date: "2026-06-29"
time: "2:50pm-3:10pm"
track: "LLM Recsys"
...
# From approval loops to autonomous agents with Docker pt4 ## Conference Context - Date/time: 2026-06-29 · 2:50pm-3:10pm - Track/room: LLM Recsys · Track 7 - Speaker(s): John Craft - Session type/status: session · confirmed - Track: LLM Recsys - Room: Track 7 - Session type: session - Status: confirmed ## Session Description You've invested in the best models, coding agents, and AI tooling. Now comes the hard part: unlocking autonomous development without creating security headaches, governance gaps, or endless approval loops. In this 90-minute hands-on workshop, you'll learn how to run coding agents in isolated environments built for autonomous work, create a 'golden path' for AI-assisted development across your organization, reduce software supply chain risk with secure, hardened containers, manage multiple agents with the right permissions and guardrails, and scale AI-powered development without slowing developers down. ## Media Evidence No related AI Engineer channel video found yet.
