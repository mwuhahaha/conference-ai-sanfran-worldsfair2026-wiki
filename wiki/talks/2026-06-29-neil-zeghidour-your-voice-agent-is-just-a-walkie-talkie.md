...
# Your Voice Agent is Just a Walkie-Talkie ## Conference Context - Date/time: 2026-06-29 · 12:05pm-12:25pm - Track/room: Claws & Personal Agents · Track 6 - Speaker(s): Neil Zeghidour - Session type/status: session · confirmed - Track: Claws & Personal Agents - Room: Track 6 - Session type: session - Status: confirmed ## Session Description Everyone says cascaded voice pipelines are dead and native speech models are the future. Yet production environments are still dominated by STT-LLM-TTS stacks. Reconciling the natural flow of native audio with the elite reasoning of a cascaded agent remains an unsolved systems problem. This talk dissects the brutal technical trade-offs behind that counterintuitive reality.
