...
### Topics Covered
- [[platform-context-and-collaboration|Environment-centered post-training]] — The idea that environments are the shared abstraction for evaluation, training, and data generation.
- [[context-engineering-and-knowledge-architecture|Verifiers V1]] — The refactored Verifiers architecture built around task sets, harnesses, and runtimes.
- [[autoresearch|Async RL orchestration]] — Training and rollout management that overlaps slow episodes by keeping inference and training separate.
- **Group rewards** — Reward design that compares grouped samples to balance correctness and efficiency.
...
- **Hosted training platform** — Managed self-serve training that supports multi-tenant LoRA and upcoming full fine-tuning.
