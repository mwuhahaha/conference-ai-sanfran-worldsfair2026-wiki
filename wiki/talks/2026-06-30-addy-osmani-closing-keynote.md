...
Howdy, folks. So, good afternoon or good whatever time it is when you're watching this on YouTube. I'm really excited to be here. And um today I want to talk to you about really uh what it takes to keep the human in the loop where engineering is concerned.
...
- [[youtube-n97BCfyFIvw-transcript]] — dedicated official recording transcript; source cache `raw/sources/youtube-transcripts/n97BCfyFIvw.txt` (3,068 words).
- [[youtube-n97BCfyFIvw]] — related YouTube source page.
- [[youtube-n97BCfyFIvw-slides]] — slide evidence.
