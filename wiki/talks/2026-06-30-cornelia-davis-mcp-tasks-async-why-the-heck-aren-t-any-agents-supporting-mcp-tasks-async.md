...
## Supporting Slides
- [[youtube-k8cnVCMYmNc-slides]] — extracted from the related public AI Engineer video.

## Slide Evidence
- Slide-only cropped deck: [[youtube-k8cnVCMYmNc-dense-slides]] (11 viable slide images).
...
# MCP Tasks (async)/ Why the heck aren't any agents supporting MCP tasks/async? ## Conference Context - Date/time: 2026-06-30 · 3:20pm-3:40pm - Track/room: Context Engineering · Track 8 - Speaker(s): Cornelia Davis - Session type/status: session · confirmed - Track: Context Engineering - Room: Track 8 - Session type: session - Status: confirmed ## Session Description The November 2025 MCP spec release introduced tasks, a way to make tool calls in an async manner. But more than 5 months later (an eternity in AI-time) there are still NO clients that support it - not Claude, not Codex, not even goose! I believe there are two reasons: Designing the client experience when there are potentially 1000s of background tasks running on their own schedule and engaging humans at unpredictable times is a challenge.

### Speaker And Company Context
- [[cornelia-davis|Cornelia Davis]] — Principal Technologist at [[temporal|Temporal]].
...
- [[youtube-k8cnVCMYmNc]] — related YouTube source page.
- [[youtube-k8cnVCMYmNc-slides]] — slide evidence.
- [[youtube-k8cnVCMYmNc-reconstructed-slides]] — slide evidence.
- [[youtube-k8cnVCMYmNc-dense-slides]] — slide evidence.
