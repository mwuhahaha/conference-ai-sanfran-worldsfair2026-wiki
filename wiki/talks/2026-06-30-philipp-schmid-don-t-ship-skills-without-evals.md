...
### Topics Covered
- [[agent-evaluations|Capability skills]] — Skills that improve abilities the model cannot yet do consistently and may later become unnecessary.
...
- [[agent-evaluations|No-ops]] — Short, non-behavior-changing instructions that should be removed because they add cost without value.
