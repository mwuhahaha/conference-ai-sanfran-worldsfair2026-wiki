...
### Topics Covered
- [[agent-memory|Field guide to Fable]] — How to adapt prompting, tools, and harnesses to a new model class with more latent capability.
- [[forward-deployed-engineering|Capability overhang]] — The idea that model usefulness can jump when paired with tools instead of only scaling parameters or context.
- [[observed-work-and-traceability|Map and territory]] — The distinction between what the operator thinks they know and the real constraints in the environment.
- [[context-engineering-and-knowledge-architecture|Unknown unknowns]] — Structured techniques for uncovering missing requirements before implementation.
- [[forward-deployed-engineering|Grief and gain from AI coding]] — The emotional and professional adjustment to faster, easier coding workflows.
