...
Please welcome to the stage member of technical staff at Anthropic, Tarik Shaupar. Hey everyone, I'm Tarik. I work at Anthropic on Claude Code. Before we get started, we have a tradition on Claude Code where we take a selfie before a talk.
...
- [[youtube-9fubhllmsBU-transcript]] — dedicated official recording transcript; source cache `raw/sources/youtube-transcripts/9fubhllmsBU.txt` (3,542 words).
- [[youtube-9fubhllmsBU]] — related YouTube source page.
- [[youtube-9fubhllmsBU-slides]] — slide evidence.
