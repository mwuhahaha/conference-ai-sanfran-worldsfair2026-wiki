---
title: "Edge-Native AI: Building Ultra-Fast Agents and MCP Servers with Spin"
category: "talks"
date: "2026-06-30"
time: "1:55pm-2:15pm"
track: "Expo Stage 2"
...
# Edge-Native AI: Building Ultra-Fast Agents and MCP Servers with Spin ## Conference Context - Date/time: 2026-06-30 · 1:55pm-2:15pm - Track/room: Expo Stage 2 · Expo Stage 1 NE - Speaker(s): Thorsten Hans - Session type/status: session · confirmed - Track: Expo Stage 2 - Room: Expo Stage 1 NE - Session type: session - Status: confirmed ## Session Description Centralized AI is slow; Edge-native AI is the revolution. Thorsten Hans demonstrates how to build intelligent agents and Model Context Protocol (MCP) servers that run at the speed of light. Using Spin and WebAssembly, we'll bypass the "cloud tax" of high latency and cold starts. Discover how to ship AI-driven features that live closer to your users, ensuring sub-millisecond responsiveness and enhanced privacy.

### Speaker And Company Context
- [[thorsten-hans|Thorsten Hans]] — Senior Developer Advocate at [[akamai|Akamai]].
