...
# Don't be data poor ## Conference Context - Date/time: 2026-07-01 · 3:20pm-3:40pm - Track/room: AI in Healthcare · Track 7 - Speaker(s): Anuj Iravane - Session type/status: session · confirmed - Track: AI in Healthcare - Room: Track 7 - Session type: session - Status: confirmed ## Session Description What do you do when the data you most need to train and evaluate on is the data you're least allowed to keep? It's a bind for anyone building AI in a high-stakes vertical: the cases that would teach your model the most — the rare, the messy, the sensitive — tend to be the ones wrapped in the tightest constraints. In healthcare it's near-absolute. PHI can't be retained, reused, or transformed, so your long-lived datasets can't contain real patient data at all.

### Speaker And Company Context
- [[anuj-iravane|Anuj Iravane]] — Head of AI at [[anterior|Anterior]].
