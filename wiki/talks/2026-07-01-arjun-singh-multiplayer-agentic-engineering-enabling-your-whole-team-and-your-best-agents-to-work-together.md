...
# Multiplayer agentic engineering: enabling your whole team and your best agents to work together ## Conference Context - Date/time: 2026-07-01 · 1:55pm-2:15pm - Track/room: Agentic Engineering · Track 8 - Speaker(s): Arjun Singh - Session type/status: session · confirmed - Track: Agentic Engineering - Room: Track 8 - Session type: session - Status: confirmed ## Session Description For a solo developer, coding agents are a superpower. For a team, they surface new kinds of bottlenecks: coordination, visibility, review, and shared context. We wanted our whole team and our best agents to work together, with no work or context trapped on any one developer's machine. So we pressed pause on the product we were building to create a multiplayer cloud workspace for agentic engineering.

### Speaker And Company Context
- [[arjun-singh|Arjun Singh]] — Co-founder and CEO at [[superconductor|Superconductor]].
