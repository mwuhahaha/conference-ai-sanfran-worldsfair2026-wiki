...
# Shipping AI to a Million Patients Without an A/B Test ## Conference Context - Date/time: 2026-07-01 · 11:40am-12:00pm - Track/room: AI in Healthcare · Track 7 - Speaker(s): Jared Joselowitz - Session type/status: session · confirmed - Track: AI in Healthcare - Room: Track 7 - Session type: session - Status: confirmed ## Session Description You can't A/B test on patients. You can't unsend a phone call. The model card won't save you at the post-incident review. Most AI eng playbooks assume the opposite.

### Speaker And Company Context
- [[jared-joselowitz|Jared Joselowitz]] — AI Research Engineer at [[ufonia|Ufonia]].
