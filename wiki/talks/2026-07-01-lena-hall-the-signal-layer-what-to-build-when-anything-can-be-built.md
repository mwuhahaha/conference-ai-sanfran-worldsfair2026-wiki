---
title: "The Signal Layer: What to Build When Anything Can Be Built"
category: "talks"
date: "2026-07-01"
time: "3:20pm-3:40pm"
...
# The Signal Layer: What to Build When Anything Can Be Built ## Conference Context - Date/time: 2026-07-01 · 3:20pm-3:40pm - Track/room: AI-Native Enterprises · Leadership 1 - Speaker(s): Lena Hall - Session type/status: session · confirmed - Track: AI-Native Enterprises - Room: Leadership 1 - Session type: session - Status: confirmed ## Session Description AI has made implementation faster, cheaper, and more widely available. That changes the real bottleneck in software. When every team can generate code, spin up agents, prototype workflows, and ship demos faster than ever, the advantage moves to a different layer: knowing what is worth building, who it is for, how people will discover it, and how the product should behave once they do. This talk introduces the Signal Layer: the system of public signals, user intent, agent experience, distribution loops, and product judgment that helps builders decide what deserves to exist before they commit time, infrastructure, and trust to building it.

### Speaker And Company Context
- [[lena-hall|Lena Hall]] — Senior Director Developers and AI at [[akamai|Akamai]].
